...
from sentence_transformers import SentenceTransformer, CrossEncoder, LoggingHandler, util, models, evaluation, losses, InputExample
...
if __name__ == "__main__":
    ...
    parser.add_argument("-d", "--path_test", type=str, default="ehr", 
    ...
    parser.add_argument("-c", "--cross_encoder", type=bool, default=True, 
